//giá trị mặc định bđầu: initialState
let initialState = [
  {
    id: "topcloth_1",
    type: "topclothes",
...
//Khởi tạo 1 reducer nhận vào 2 tham số :
//1:giá trị mà nó đang lưu trữ(products)
//2:nhận 1 action từ component
const ProductReducer = (state = initialState, action) => {
  switch (action.type) {
    //đúng action thì xử lý,nếu k => default
    default:
      return state;
  }
};
